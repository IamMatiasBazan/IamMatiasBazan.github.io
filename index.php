...
<html lang="es">
    <head>
        ...
        <title>Portafolio - Matias Bazán</title>
    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <h1 class="masthead-heading text-uppercase mb-0">Matias Bazán</h1>
                <div class="divider-custom divider-light">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                    <div class="divider-custom-line"></div>
                </div>
                <p class="masthead-subheading font-weight-light mb-0">Programación - Ingeniería en Electrónica</p>
            </div>
        </header>
        <!-- Portfolio-->
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/workshop-html-css.png" alt="..." />
                        </div>
                    </div>
                    <!-- Portfolio 2-->
                    <div class="col-md-6 col-lg-4 mb-5">
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">Como ya habrás podido ver, me llamo Matias Sebastián Bazan. Soy programador y estudiante de Ingeniería
                        en Electrónica. Desde niño me fascinaba la posibilidad de crear aplicaciones a través de un ordenador. </p></div>
                ...
                <div class="text-center mt-4">
                    <a class="btn btn-xl btn-outline-light" download="cv" href="cv/trabajosPracticos.pdf">
